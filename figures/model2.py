...
co2a  = np.loadtxt('../simulations/fe31/co2.txt', skiprows=2)
co4a  = np.loadtxt('../simulations/fe31/co4.txt', skiprows=2)
co8a  = np.loadtxt('../simulations/fe31/co8.txt', skiprows=2)
cm2a  = np.loadtxt('../simulations/fe31/cm2.txt', skiprows=2)
cm4a  = np.loadtxt('../simulations/fe31/cm4.txt', skiprows=2)
cm8a  = np.loadtxt('../simulations/fe31/cm8.txt', skiprows=2)
ro2a  = np.loadtxt('../simulations/fe31/ro2.txt', skiprows=2)
ro4a  = np.loadtxt('../simulations/fe31/ro4.txt', skiprows=2)
ro8a  = np.loadtxt('../simulations/fe31/ro8.txt', skiprows=2)
rm2a  = np.loadtxt('../simulations/fe31/rm2.txt', skiprows=2)
rm4a  = np.loadtxt('../simulations/fe31/rm4.txt', skiprows=2)
rm8a  = np.loadtxt('../simulations/fe31/rm8.txt', skiprows=2)
to2a  = np.loadtxt('../simulations/fe31/to2.txt', skiprows=2)
to4a  = np.loadtxt('../simulations/fe31/to4.txt', skiprows=2)
to8a  = np.loadtxt('../simulations/fe31/to8.txt', skiprows=2)
tm2a  = np.loadtxt('../simulations/fe31/tm2.txt', skiprows=2)
tm4a  = np.loadtxt('../simulations/fe31/tm4.txt', skiprows=2)
tm8a  = np.loadtxt('../simulations/fe31/tm8.txt', skiprows=2)

co2b  = np.loadtxt('../simulations/fe32/co2.txt', skiprows=2)
co4b  = np.loadtxt('../simulations/fe32/co4.txt', skiprows=2)
co8b  = np.loadtxt('../simulations/fe32/co8.txt', skiprows=2)
cm2b  = np.loadtxt('../simulations/fe32/cm2.txt', skiprows=2)
cm4b  = np.loadtxt('../simulations/fe32/cm4.txt', skiprows=2)
cm8b  = np.loadtxt('../simulations/fe32/cm8.txt', skiprows=2)
ro2b  = np.loadtxt('../simulations/fe32/ro2.txt', skiprows=2)
ro4b  = np.loadtxt('../simulations/fe32/ro4.txt', skiprows=2)
ro8b  = np.loadtxt('../simulations/fe32/ro8.txt', skiprows=2)
rm2b  = np.loadtxt('../simulations/fe32/rm2.txt', skiprows=2)
rm4b  = np.loadtxt('../simulations/fe32/rm4.txt', skiprows=2)
rm8b  = np.loadtxt('../simulations/fe32/rm8.txt', skiprows=2)
to2b  = np.loadtxt('../simulations/fe32/to2.txt', skiprows=2)
to4b  = np.loadtxt('../simulations/fe32/to4.txt', skiprows=2)
to8b  = np.loadtxt('../simulations/fe32/to8.txt', skiprows=2)
tm2b  = np.loadtxt('../simulations/fe32/tm2.txt', skiprows=2)
tm4b  = np.loadtxt('../simulations/fe32/tm4.txt', skiprows=2)
...
ax3.plot(cm2[:, 0], cm2[:, 4], 'b-', cm4[:, 0], cm4[:, 4], 'g-', cm8[:, 0], cm8[:, 4], 'r-', \
         cm2a[:, 0], cm2a[:, 4], 'b--', cm4a[:, 0], cm4a[:, 4], 'g--', cm8a[:, 0], cm8a[:, 4], 'r--', \
...
ax5.plot(ro2[:, 0], ro2[:, 4], 'b-', ro4[:, 0], ro4[:, 4], 'g-', ro8[:, 0], ro8[:, 4], 'r-', \
         ro2a[:, 0], ro2a[:, 4], 'b--', ro4a[:, 0], ro4a[:, 4], 'g--', ro8a[:, 0], ro8a[:, 4], 'r--', \
